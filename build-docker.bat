...
docker run -e "DB_IP=%db_ip%" -e "DB_PASS=EtherealDatabaseStorage!!" -e "BUCK_IP=%buck_ip%" -p 8090:8090 --name storage-controller --hostname storage-controller -d storage-controller
